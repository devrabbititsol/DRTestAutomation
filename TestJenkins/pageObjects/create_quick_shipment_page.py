...
class CreateQuickShipmentPageLocators:
    ...
    BACK_TO_CREATE_SHIPMENT_BUTTON = (By.CSS_SELECTOR, "#mainbody > div.wrapper.ng-scope > section > div > section > form > span > span")
...
class CreateQuickShipmentPage(BaseUI):
    ...
    def visit(self):
        self.custom_wait()
        self.driver.navigate().to(CreateQuickShipmentPage.URL)


    # Method for Fill Deliver TO Field
    def click_quick_ship_rocket(self):
        self.mouse_over(CreateQuickShipmentPageLocators.ORDERS_LINK)

    def fill_deliver_address_field(self):
        self.set(CreateQuickShipmentPageLocators.DELIVERY_ADDRESS_FIELD, 'Tirupathi')
    # Method for Fill Deliver TO Field
