 ...
 */
@WebServlet("/Pages")
public class PagesList extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			if (client.connect()) {
				System.out.println("DB connected moduleId id"+testcaseId);
				
				ResultSet rs = client.execQuerywithParams(QueryConstants.GETPAGES, testcaseId);	
